                  ...
                  <div class="control">
                        <form action="" method="post">
                            <div class="field">
                              ...
                              <div class="control">
                                <input type="email" class="input mb-3 is-link" name="username" placeholder="Enter email">
                              </div>
                            </div>
                            <div class="field">
                            ...
                            <div class="field">
                              <div class="control is-flex is-justify-content-center">
                                <input type="submit" class="button custom-background-color has-text-white is-size-6 mb-3" value="Log in">
                              </div>
                            </div>
                        </form> 
                  </div>
